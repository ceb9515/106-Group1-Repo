...
namespace Project1
{
    public class Game1 : Game
    {
        ...
        public void LoadGame()
        {
            ...
            player1 = new Player(PlayerText1, 320, 360, 40, 40, 20, 2, 1, 0, player1Position, playerManager.player1Controls, Bullettext, PlayerCrash1);
            player2 = new Player(PlayerText2, 960, 360, 40, 40, 20, 2, 1, 180, player2Position, playerManager.player2Controls, Bullettext, PlayerCrash2);
