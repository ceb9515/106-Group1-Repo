...
namespace Project1
{
    public class Game1 : Game
    {
        ...
        public void LoadGame()
        {
            ...
            player1 = new Player(Playertext, 320, 360, 40, 40, 5, 1, 1, 0, player1Position, playerManager.player1Controls);
            player2 = new Player(Playertext, 960, 360, 40, 40, 5, 1, 1, 180, player2Position, playerManager.player2Controls);
